...
def main():
    ...
    #encrypted
    #filename = 'amazon_gen1_1.pcapng'
    #filename = 'google_home_1.pcapng'
    #filename = 'phillips_hue_1.pcapng'
    #filename = 'TP_link_kasa.pcapng'
    #filename = 'xiaomi_1.pcapng'

    #unencrypted
    #filename = 'dlink_cam_2.pcapng'
    #filename = 'insteon_cam_wired.pcap'
    #filename = 'LiFX_5.pcap'
    #filename = 'Samsung_cam.pcap'
    #filename = 'vera_mob_cloud.pcap'
    #filename = 'withings_scale_merge.pcap'
    ...
    parser.add_argument('-f', dest="filename", required=True, help="filename of PCAP file")
    parser.add_argument('-p', action="store_false", default=None, help='overview of ports', )
    parser.add_argument('-cn', action="store_false", default=None, help='overview of connections', )
    parser.add_argument('-cnlist', action="store_false", default=None, help='list of connections', )
    parser.add_argument('-ips', action="store_false", default=None, help='list of ips', )
    parser.add_argument('-g', action="store_false", default=None, help='overview of IPs and geolocation data', )
    parser.add_argument('-ct', action="store_false", default=None, help='overview of cleartext', )
    parser.add_argument('-e', action="store_false", default=None, help='calculated entropy values', )
...
#######################################################################################################################
    ...
    #memoryUse = p.memory_percent()
    #cpuUse = p.cpu_percent() / psutil.cpu_count()
