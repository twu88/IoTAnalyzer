...
"""IoT Network Analyzer tool

Usage:
    iot_analyzer.py (<filename>) [-p]
    iot_analyzer.py (<filename>) [-p] [-cn]
    iot_analyzer.py (<filename>) [-pcne]
    iot_analyzer.py-f [OPTIONS]
    iot_analyzer.py -h | --help
    iot_analyzer.py --version
...
Options:
    ...
    -f                  :filename of PCAP file
    -p                  :overview of ports
    -cn                 :overview of connections
    -cnlist				:list of connections
    -i                  :overview of ips
    -g                  :overview of IPs and geolocation data
    -ct                 :overview of cleartext
    -e                  :calculated entropy values
"""
...
#   pp = pprint.PrettyPrinter(indent=1)
    ...
    if args['-p']:
        ...
        print("Overview of all recorded IPs (origin & destination): ")
